function [id,words] = import_prompts(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [ID,WORDS] = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   [ID,WORDS] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [id,words] = importfile('01_duet_4',1, 50);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/04/08 20:25:08
