...
tframp = load('C:\Users\SMukherjee\Desktop\projects\dual_eeg_eng\data\dual_eng\mat\mvpa\prespeech_tfr_sig.mat');
...
glm_coeff1 = zeros(16,channel_no,40,21);  %amp
glm_coeff2 = zeros(16,channel_no,40,21); %sine phase
glm_coeff3 = zeros(16,channel_no,40,21); %cos phase
